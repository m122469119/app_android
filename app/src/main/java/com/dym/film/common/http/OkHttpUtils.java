...
import com.dym.film.common.http.callback.HttpCallback;
import com.dym.film.common.http.cookie.SimpleCookieJar;
...
public class OkHttpUtils
{
    ...
    private OkHttpUtils()
    {
        ...
        okHttpClientBuilder.readTimeout(10000,TimeUnit.MILLISECONDS);
