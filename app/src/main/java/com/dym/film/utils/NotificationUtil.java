...
public class NotificationUtil {
    ...
    @SuppressLint("NewApi") public static void notification(Context context, int icon, String ticker, String title, String msg, Uri uri, String activityClassName) {
        //Logi(TAG, "notiry uri :" + uri);
        // 设置通知的事件消息
