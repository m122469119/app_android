...
public class SwipeItemLayout extends RelativeLayout
{
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, cn.bingoogolapple.swipeitemlayout.R.styleable.BGASwipeItemLayout);
    ...
    private void initAttr(int attr, TypedArray typedArray) {
        ...
        } else if (attr == R.styleable.SwipeItemLayout_bottomMode) {
            // 默认是拉出
        ...
        } else if (attr == R.styleable.SwipeItemLayout_swipeAble) {
