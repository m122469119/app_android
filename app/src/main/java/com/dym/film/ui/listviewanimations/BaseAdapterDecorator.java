 ...
 */
package com.dym.film.ui.listviewanimations;
...
import com.dym.film.ui.listviewanimations.util.AbsListViewWrapper;
import com.dym.film.ui.listviewanimations.util.Insertable;
import com.dym.film.ui.listviewanimations.util.ListViewWrapper;
import com.dym.film.ui.listviewanimations.util.ListViewWrapperSetter;
import com.dym.film.ui.listviewanimations.util.Swappable;
...
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable, ListViewWrapperSetter {
    ...
    public void swapItems(final int positionOne, final int positionTwo) {
        if (mDecoratedBaseAdapter instanceof Swappable) {
            ...
            //Logw("ListViewAnimations", "Warning: swapItems called on an adapter that does not implement Swappable!");
        }
    }
    ...
    public void add(final int index, @NonNull final Object item) {
        if (mDecoratedBaseAdapter instanceof Insertable) {
            ...
            //Logw("ListViewAnimations", "Warning: add called on an adapter that does not implement Insertable!");
        }
    }
}